...
public interface TicketRepository extends MongoRepository<Ticket, String> {
	...
	Page<Ticket> findByTitleIgnoreCaseContainingAndStatusAndPriorityAndAssignedUserOrderByDateDesc(String title, String status, String priority, Pageable pages);	
